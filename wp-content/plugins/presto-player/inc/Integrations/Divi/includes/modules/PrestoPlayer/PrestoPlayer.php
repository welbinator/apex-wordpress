...
class DiviPrestoPlayer extends ET_Builder_Module
{
    ...
    {
        $this->name = esc_html__('Presto Player', 'presto-player');
    ...
    public function get_fields()
    {
        return array(
            'video_id' => array(
                'label'           => esc_html__('Choose a video', 'presto-player'),
                'type'            => 'prpl_video_selector',
                'option_category' => 'basic_option',
                'description'     => esc_html__('Select a video from the media hub.', 'presto-player'),
            ...
            'url_override' => array(
                ...
                'type'            => 'text',
                'description'     => esc_html__('Please choose a video above before selecting dynamic URL override.', 'presto-player'),
