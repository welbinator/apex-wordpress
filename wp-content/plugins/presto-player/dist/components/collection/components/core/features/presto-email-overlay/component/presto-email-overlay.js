...
export class PrestoEmailOverlay {
  ...
  render() {
    var _a, _b;
    return (h("presto-email-overlay-controller", { ended: this.ended, currentTime: this.currentTime, videoId: this.videoId, duration: this.duration, direction: this.direction, presetId: (_a = this.preset) === null || _a === void 0 ? void 0 : _a.id, emailCollection: (_b = this.preset) === null || _b === void 0 ? void 0 : _b.email_collection, i18n: this.i18n }));
  }
