...
<div class="frm_email_row">
	...
	<?php if ( ! empty( $can_generate_csv_file ) ) { ?>
		<div class="with_frm_style">
			<label class="frm_switch_block">
				<input id="frm_attach_csv" name="<?php echo esc_attr( $pass_args['action_control']->get_field_name( 'attach_csv' ) ); ?>" type="checkbox" class="frm_hidden" <?php checked( ! empty( $form_action->post_content['attach_csv'] ) ); ?> />
